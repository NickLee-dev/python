# 경로표시 \\ 사용표기 : mission\\dict_mission1.py
# 경로표시 / 사용 표기 가능 : mission/dict_mission1.py
# 모듈로 표시 : mission.dict_mission1
...
def dict_func():
    ...
    print("{}학년 {}반 {}번 {}의 점수는 {:.2f}입니다."
          .format(student_dict['grade'],student_dict['s_class']
                  ,student_dict['s_no'],student_dict['name'],student_dict['score']))